        ...
        <div className="flex-1 overflow-y-auto p-4 md:p-8">
          <div className="max-w-5xl mx-auto flex flex-col gap-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              <div className="p-4 rounded-lg bg-[#0f141c] border border-[#1c2333] flex flex-col gap-1.5">
                ...
                <div className="text-2xl font-bold font-mono text-white mt-1">104.2%</div>
              ...
              <div className="p-4 rounded-lg bg-[#0f141c] border border-[#1c2333] flex flex-col gap-1.5">
                ...
                <div className="text-2xl font-bold font-mono text-white mt-1">+0.54°C</div>
              ...
              <div className="p-4 rounded-lg bg-[#0f141c] border border-[#1c2333] flex flex-col gap-1.5">
                ...
                <div className="text-2xl font-bold font-mono text-white mt-1">28 / 36</div>
            ...
            <div className="p-5 rounded-lg bg-[#0f141c] border border-[#1c2333]">
              <div className="flex items-center justify-between mb-6">
                ...
                <div className="flex items-center gap-4 text-xs font-mono">
                  <div className="flex items-center gap-1.5">
                    ...
                    <span className="text-slate-300">Actual 2026</span>
                  </div>
                  <div className="flex items-center gap-1.5">
                    <span className="w-2.5 h-2.5 rounded-sm bg-slate-600" />
                    <span className="text-slate-400">LPA Normal</span>
                  </div>
                </div>
              </div>

              {/* Bar visualization */}
              <div className="h-56 flex items-end justify-between gap-2 pt-6 pb-2 border-b border-[#1c2333]">
                    ...
                    <div key={t.month} className="flex-1 flex flex-col items-center gap-1 h-full justify-end group">
                      <div className="w-full flex items-end justify-center gap-1 h-full">
                        ...
                        <div
                          ...
                          className="w-2.5 sm:w-3.5 bg-slate-700/80 rounded-t-sm transition-all group-hover:bg-slate-600"
            ...
            <div className="p-5 rounded-lg bg-[#0f141c] border border-[#1c2333]">
              ...
              <div className="overflow-x-auto">
                <table className="w-full text-left text-xs font-sans">
                  <thead>
                    <tr className="border-b border-[#1c2333] text-[10px] font-mono uppercase tracking-wider text-slate-500">
                  ...
                  <tbody className="divide-y divide-[#1c2333]/60">
                    {REGIONAL_CLIMATE_STATS.map((row, idx) => (
                      <tr key={idx} className="hover:bg-white/[0.02] transition-colors">
                        <td className="py-3 font-medium text-slate-200">{row.region}</td>
                        <td className="py-3 font-mono text-slate-300">{row.avgTemp}°C</td>
                        <td className="py-3 font-mono text-slate-300">{row.humidity}%</td>
                        ...
                        <td className="py-3 font-mono text-slate-300">{row.uvIndex} / 11</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
