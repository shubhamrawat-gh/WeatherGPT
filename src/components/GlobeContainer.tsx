import { lazy, Suspense, forwardRef, useImperativeHandle, useRef, useState, useEffect } from 'react'
...
const GlobeContainer = forwardRef<GlobeContainerRef, GlobeContainerProps & { disableTelemetry?: boolean }>((props, ref) => {
  ...
  useEffect(() => {
    if ('requestIdleCallback' in window) {
      const id = (window as any).requestIdleCallback(() => setShouldMount(true), { timeout: 600 })
