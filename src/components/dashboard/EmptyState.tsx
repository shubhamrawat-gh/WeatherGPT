...
export default function EmptyState({
  ...
  description,
  action,
  badgeText = 'Future Integration',
}: EmptyStateProps) {
  return (
    <div className="flex flex-col items-center justify-center text-center p-8 md:p-16 rounded-xl border border-dashed border-hairline-dark/65 bg-surface-dark/15 backdrop-blur-sm max-w-xl mx-auto w-full select-none">
      {/* Icon frame */}
